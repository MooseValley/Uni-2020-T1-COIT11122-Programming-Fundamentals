...
public class LectureGuiExample extends JFrame
{
   ...
   JComboBox<String> planeTypeDialogComboBox  = new JComboBox<String> (PLANE_TYPES);
   ...
   JButton    selectPlaneButton = new JButton    ("Select Plane" );
   ...
   public LectureGuiExample()
   {
      ...
      selectPlaneButton.addActionListener (event -> selectPlane() );
